...
$string['choosereadme'] = 'Move es un tema moderno altamente personalizable. Este tema está destinado a ser utilizado directamente o como tema principal al crear nuevos temas utilizando Bootstrap 4.';
...
$string['cachedef_fontawesomemoveiconmapping'] = 'Definición de fuente de icono de tema';
...
$string['privacy:metadata:preference:thememovesettings_fonttype'] = 'The user\'s preference for font type.';
$string['privacy:metadata:preference:thememovesettings_enableaccessibilitytoolbar'] = 'The user\'s preference for enable the accessibility toolbar.';
...
$string['privacy:thememovesettings_fonttype'] = 'The current preference for the font type is: {$a}.';
$string['privacy:thememovesettings_enableaccessibilitytoolbar'] = 'The current preference for enable accessibility toolbar is to show it.';
