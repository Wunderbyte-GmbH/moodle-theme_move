...
define(['jquery', 'core/notification', 'core/custom_interaction_events', 'core/modal', 'core/modal_registry', 'core/ajax'],
    function(jQuery, Notification, CustomEvents, Modal, ModalRegistry, Ajax) {
        ...
        ThemeSettingsModal.TYPE = 'theme_move-themesettings_modal';
        ...
        if (!registered) {
            ModalRegistry.register(ThemeSettingsModal.TYPE, ThemeSettingsModal, 'theme_move/themesettings_modal');
            registered = true;
        }
