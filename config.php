...
$THEME->scss = function($theme) {
    return theme_move_get_main_scss_content($theme);
};
...
$THEME->extrascsscallback = 'theme_move_get_extra_scss';
$THEME->prescsscallback = 'theme_move_get_pre_scss';
$THEME->precompiledcsscallback = 'theme_move_get_precompiled_css';
$THEME->yuicssmodules = [];
