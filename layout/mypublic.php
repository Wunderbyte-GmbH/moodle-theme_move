...
/**
 * A two column layout for the move theme.
 *
 * @package   theme_move
...
$usercourses = \theme_move\util\extras::user_courses_with_progress($user);
...
$templatecontext['user']->profilepicture = \theme_move\util\extras::get_user_picture($user, 100);
$templatecontext['user']->fullname = fullname($user);

$competencyplans = \theme_move\util\extras::get_user_competency_plans($user);
$templatecontext['hascompetencyplans'] = (count($competencyplans)) ? true : false;
$templatecontext['competencyplans'] = $competencyplans;

$templatecontext['headerbuttons'] = \theme_move\util\extras::get_mypublic_headerbuttons($context, $user);
